...
$jsonarray=array_merge(...json_decode($json,true));
var_dump($jsonarray);
$allOrders=0;
$shipped=$jsonarray[0];
$processing=$jsonarray[2];
$cancelled=$jsonarray[1];
for($i=0;$i<count($jsonarray);$i++){
    $allOrders+=$jsonarray[$i];
}
$poProcessin=$processing*100/$allOrders; 
$poProcessing=number_format((float)$poProcessin, 2, '.', '');   
$poShippe=$shipped*100/$allOrders;
$poShipped=number_format((float)$poShippe, 2, '.', '');   
$poCancelle=$cancelled*100/$allOrders; 
$poCancelled= number_format((float)$poCancelle, 2, '.', '');   
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="card widget h-100">
                ...
                <h6 class="card-title">
                        ...
                        <a href="#" class="bi bi-question-circle ms-1 small" data-bs-toggle="tooltip"
                           title="the status of the products"></a>
                    </h6>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="card border-0">
                            <div class="card-body text-center">
                                ...
                                <div class="text-muted"><?php echo $processing;?> Orders</div>
                                <div class="progress mt-3" style="height: 5px">
                                    <div class="progress-bar bg-secondary" role="progressbar" style="width: <?php echo $poProcessing; ?>%"
                                         aria-valuenow="<?php echo $poProcessing; ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card border-0">
                            <div class="card-body text-center">
                                ...
                                <h5 class="my-3">Cancelled</h5>
                                <div class="text-muted"><?php echo $cancelled?>  Orders</div>
                                <div class="progress mt-3" style="height: 5px">
                                    <div class="progress-bar bg-warning" role="progressbar" style="width: <?php echo $poCancelled?>%"
                                         aria-valuenow="<?php echo $poCancelled?> " aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card border-0">
                            <div class="card-body text-center">
                                ...
                                <h5 class="my-3">Shipped</h5>
                                <div class="text-muted"><?php echo $shipped;?> Orders</div>
                                <div class="progress mt-3" style="height: 5px">
                                    <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo  $poShipped; ?>%"
                                         aria-valuenow="<?php echo  $poShipped; ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card widget h-100">
                <div class="card-header d-flex">
                    <h6 class="card-title">
                        ...
                        <a href="#" class="bi bi-question-circle ms-1 small" data-bs-toggle="tooltip"
                           title="percentage of each status"></a>
                    </h6>
      ...
      chart.render();
                    ...
                    <div class="row text-center mb-5 mt-4">
                        <div class="col-4">
                            <div class="display-7"><?php echo $poProcessing?>%</div>
                        ...
                        <div class="col-4">
                            <div class="display-7"><?php echo $poShipped?>%</div>
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="d-flex mb-3">
                        <div class="display-7"><?php echo $allOrders ;?></div>
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="d-flex mb-3">
                        <div class="display-7"><?php echo $ordersC->sumTotalMoney();?></div>
