...
<head>
    ...
    <title> Checkout - Vetra | E-Commerce HTML Admin Dashboard Template </title>
            ...
            <div id="checkout-form-wizard">
                ...
                <div class="row g-4 mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="daterangepicker" class="form-control" name="date_demande">
                    </div>
                    </div>
                    ...
                    <div class="row g-4 mb-3">
                <div class="col-md-6" >
                    <input type="file" name="media_product" id="media_product"/>
                </div>
